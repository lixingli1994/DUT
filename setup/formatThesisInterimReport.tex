...
\fancyhf{}
\fancyhead[CO]{\song\wuhao{大连理工大学博士中期考核报告}}
...
\def\makecover{
  \begin{titlepage}
    ...
    \begin{center}\xiaoyi\hwzsong \textbf{博~士~生~中~期~考~核~报~告}\end{center} }
...
\def\Declare 
{
  ...
  \xiaosiyidianwu\song\noindent
  　　
     博士生中期考核是保证博士课题工作进度、学位论文质量和博士生培养质量的关键性环节。%

    一、考核内容：学位论文内容完成情况、阶段性成果是否正确、创新性成果是否成立，开题时方案是否需调整或已做了哪些调整，%
    后续工作思路是否正确、工作进度是否有保障、预期目标能否实现、论文质量是否能够保证以及论文工作存在的问题、论文发表情况等。%

    二、报告撰写：中期报告正文字数不少于15000字；参考文献数量不少于30篇，其中，外文资料不少于二分之一，%
    近5年文献不少于三分之一；正文及参考文献等撰写要求参见《大连理工大学博士学位论文格式规范》。%

    三、报告保存：博士生根据专家的意见修改完善中期报告，经导师和点长签字生成PDF文档，上传到研究生信息管理系统，导师审核，由学部（学院）进行网上确认。%
